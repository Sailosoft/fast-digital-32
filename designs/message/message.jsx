  ...
  return (
    <div className="min-h-screen bg-[#fff5f5] font-sans overflow-x-hidden">
      ...
      <header
        ...
        // }}
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://wallpapers-clan.com/wp-content/uploads/2024/04/cinnamoroll-flowers-blue-sanrio-desktop-wallpaper-preview.jpg')`,
        }}

      >
        <div className="text-center text-white px-4">
          <h2 className="text-xl md:text-2xl font-light tracking-[0.3em] uppercase mb-4">
            To My Baby Juvy
          </h2>
          <h1 className="text-6xl md:text-8xl cursive mb-6 drop-shadow-lg">
            Happy Anniversary
          </h1>
        ...
        <div className="max-w-4xl mx-auto text-center">
          {!isLetterOpen ? (
            ...
            <div className="glass-card p-10 rounded-2xl shadow-xl text-left border-2 border-rose-200 transition-all duration-700 ease-out translate-y-0 opacity-100">
              <h3 className="cursive text-4xl text-rose-600 mb-6">
                My Dearest Love,
              </h3>
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                <p>
                  Every day with you feels like a beautiful dream that I never
                  want to wake up from. Looking back at our journey together,
                  I'm filled with so much gratitude for every laugh we've shared
                  and even the challenges we've overcome.
                </p>
                <p>
                  You are my best friend, my rock, and my home. Thank you for
                  choosing me every single day. I promise to keep loving you
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl text-center font-bold text-gray-800 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                img: "https://images.unsplash.com/photo-1516589174184-c6852657d803",
              },
              {
                label: "Best Summer Ever",
                img: "https://images.unsplash.com/photo-1522673607200-1648832cee98",
              },
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <div className="bg-rose-500 text-white w-8 h-8 flex items-center justify-center rounded-full text-sm">
                  ✓
                </div>
      ...
      <footer className="py-12 bg-white text-center border-t border-rose-100">
        <p className="text-gray-500 mb-4 italic">
          Cheers to many more years of us.
        </p>

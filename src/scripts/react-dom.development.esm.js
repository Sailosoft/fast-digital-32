...
System.register(['react'], (function (exports) {
	...
	return {
		...
		execute: (function () {
			...
			var reactDom_development = exports('default', {});
			...
			*/
			...
			const {
			  ...
			  version,
			} = reactDom_development; exports({ __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, createPortal: createPortal, findDOMNode: findDOMNode, flushSync: flushSync, hydrate: hydrate, render: render, unmountComponentAtNode: unmountComponentAtNode, unstable_renderSubtreeIntoContainer: unstable_renderSubtreeIntoContainer, unstable_batchedUpdates: unstable_batchedUpdates, unstable_createPortal: unstable_createPortal, version: version });
